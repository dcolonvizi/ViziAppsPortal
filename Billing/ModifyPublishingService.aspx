<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyPublishingService.aspx.cs" Inherits="ModifyPublishingService" %>
...
<body class="BODY">
    ...
    <tr>
    <td>
    <center><div class="billinglabel">Modify Publishing Service</div>
        </center>
    ...
    <tr>
    <td>
            <telerik:RadMultiPage ID="RadMultiPageMaster" runat="server" SelectedIndex="1"  CssClass="multiPage" Visible="false">
        ...
        <telerik:RadTabStrip ID="RadTabStripNative" 
                             ...
                             Font-Size="12pt" 
                             Width="450px" 
                             Skin="Web20" SelectedIndex="1" >

         
               
                <Tabs>
                    <telerik:RadTab Text="Standard Pricing"  TabIndex="0"  Font-Size="12pt" ></telerik:RadTab>
                    <telerik:RadTab Text="Pre-Pay Yearly" TabIndex="1"     Font-Size="12pt" Selected="True"  ></telerik:RadTab>
                    <telerik:RadTab Text="Non-Profits" TabIndex="2"        Font-Size="12pt" ></telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>

            <telerik:RadMultiPage ID="NativePricingMultiPage" runat="server" SelectedIndex="1"    CssClass="multiPage" > 
                ...
                <td valign="top">
                   ...
                   <table class="basicproprem" onmouseover=""  onmouseout="" >
                           <tr><td class="tick">
        ...
        <center><asp:Label ID="Label2" runat="server">Web Apps</asp:Label></center><br />       
        ...
        <telerik:RadMultiPage ID="WebPricingMultiPage" runat="server" SelectedIndex="1"  
                CssClass="multiPage" >
    ...
    <td>
    <table align="center" dir="ltr" class="tabgridpage">

   <tr>
   
   <td colspan="5" class="table_headrow">User Information</td>
           <td colspan="5">&nbsp;</td> 	</tr>
   <tr>
