...
namespace PAB.WebControls
{
   ...
   protected string ImageUrl;		
		...
		public Persistence PersistenceType
		{
			...
			set
			{
				if(value==Persistence.Session ) HttpRuntime.Session["persistenceType"]="Session";
       ...
       [Browsable(false)]
        public Bitmap Bitmap
        {
            get
            {
			if(HttpRuntime.Session["persistenceType"]!=null) this.persistenceType =Persistence.Session ;
