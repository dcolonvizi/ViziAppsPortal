<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TemplateiPhoneDetail.aspx.cs" Inherits="Dialogs_CoverFlow_img_TemplateiPhoneDetail" %>
...
<tr><td align="right" valign="middle" style="height:50px" class="style1">
    ...
    <input id="Button1" type="button" value="Back" onclick="window.location.href = 'TemplateiPhoneIndex.html';" />
</td></tr>
