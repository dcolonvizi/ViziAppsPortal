<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DuplicateApp.aspx.cs" Inherits="Dialogs_DuplicateApp" %>
    ...
    <script type="text/javascript">
        function onAjaxResponseEnd(sender, args) {
            ...
            if (Message.innerHTML == "Saved.") {
                var arg = document.getElementById("AppName").value;
                parent.window.onDuplicateAppClientClose(arg);
            }
            else
        ...
        <table style="width:100%; height: 104px;">
            <tr>
                <td class="style4">
                    &nbsp;</td>
                <td>
                                <asp:Label ID="Label2" runat="server" Text="New App Name" Font-Names="Arial" 
            ...
            <tr>
                ...
                <td class="style3">
                    <input name="AppName" type="text" id="AppName" size="40" runat="server"/></td>
            </tr>
            <tr>
                <td class="style4">
                    &nbsp;</td>
