<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadBackgroundImage.aspx.cs" Inherits="Dialogs_UploadBackgroundImage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Upload Background Image for App</title>
    <style type="text/css">
          ...
          <script type="text/javascript">
             function GetRadWindow() {
              ...
              function CloseSetBackgroundWithArg() {
                  ...
                  GetRadWindow().close(image_source.value);
                  image_source.value = '';
              }
     </script>
</head>
<body>
                ...
                <table style="width:453px;">
                    <tr>
                        <td colspan="2" style="font-family:Verdana; font-size:12px;color:#444444">
                            Upload a Background JPG Image for Your App (<asp:Label ID="Width" runat="server"
                                Text="320"></asp:Label> X 
                            <asp:Label ID="Height" runat="server" Text="460"></asp:Label> &nbsp;pixels)</td>
                    </tr>
                    <tr>
                        <td colspan="2">
 ...
 />
                             <asp:TextBox ID="ImageSource" runat="server" BorderColor="White"  
                                BorderStyle="None" BorderWidth="0px" ForeColor="White" Width="10px"  Height="10px"></asp:TextBox></td>
                        <td class="style34">
