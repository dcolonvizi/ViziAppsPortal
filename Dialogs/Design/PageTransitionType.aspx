<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PageTransitionType.aspx.cs" Inherits="Dialogs_PageTransitionType" %>
...
<body>
    ...
    <table><tr><td class="style3">
                                         <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" 
                                             Font-Size="10pt" ForeColor="#000099" Text="Page Transition Type:" 
                                        Width="157px" Height="16px"></asp:Label>
                            </td><td>
                                             <telerik:RadComboBox ID="PageTransitions" runat="server" AutoPostBack="True" 
