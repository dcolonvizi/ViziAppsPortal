<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadImage.aspx.cs" Inherits="Dialogs_UploadImage" %>
                ...
                <table style="width:453px;">
                    <tr>
                        <td colspan="2" style="font-family:Verdana; font-size:12px;color:#444444">
                            Upload an Image for Your App <br />(JPG, GIF or PNG format up to size 1024 w X 1024 h pixels)</td>
                    </tr>
                    <tr>
                        <td colspan="2">
