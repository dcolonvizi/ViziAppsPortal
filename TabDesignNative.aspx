               ...
               <table border="0" cellpadding="0" cellspacing="0" id="tabs"  style="width:100%;height:30px; border:0px; padding:0px;  vertical-align:top;  margin:0px; background-image:url(images/tabs_section.gif); background-repeat:repeat-x  ">
                    <tr><td align="center" valign="top">
                     ...
                     <td >
                      ...
                      <telerik:RadMenu ID="TabMenu" runat="server" Skin=""  OnClientItemClicked="selectMenu"                                                                    
                        ...
                        SelectedImageUrl="~/images/MySolutionsButton_sel.png"  Value="TabMySolutions.aspx" 
                                    TabIndex="1200"/>
                               <telerik:RadMenuItem ImageUrl="~/images/DisplayNativeDesignButton_sel.png" HoveredImageUrl="~/images/DisplayNativeDesignButton_hov.png"
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 849px">
                <tr>              
                    <td style="height: 10px; vertical-align:top">                                
                            ...
                            <tr>
                             <td valign="top" > 
                              <table id="edit_tools" style="font-size:11px;display:none; vertical-align:top;" cellspacing="0" cellpadding="0" runat="server">  <tr><td style=" vertical-align:top">
                              <table>                          
                              <tr>                           
                              <td>
