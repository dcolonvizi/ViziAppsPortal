...
function doSqlCommand() {
    ...
    {
        var command_condition_phone_field1 =sql_command.get("command_condition_phone_field1");
        var command_condition_operation =sql_command.get("command_condition_operation");
        var command_condition_phone_field2 =sql_command.get("command_condition_phone_field2");              
        var command_condition_phone_field1_value = null;
        var command_condition_phone_field2_value = null;

        //check Output values first
        var value = getFieldValue(command_condition_phone_field1);
        if(value != null)
        {
            command_condition_phone_field1_value = value;
        }
        else
        {
            //then check previous field values
            command_condition_phone_field1_value = getFieldValue(command_condition_phone_field1);
            if(command_condition_phone_field1_value == null)
                command_condition_phone_field1_value = command_condition_phone_field1;
        }
        value = getFieldValue(command_condition_phone_field2);
        if(value != null)
        {
            command_condition_phone_field2_value = value;
        }
        else
        {
            //then check previous field values
            command_condition_phone_field2_value = getFieldValue(command_condition_phone_field2);
            if(command_condition_phone_field2_value == null)
                command_condition_phone_field2_value = command_condition_phone_field2;
        }              
        if(command_condition_operation == "=")
        {
            if(command_condition_phone_field1_value == command_condition_phone_field2_value)
            {
	    ...
	    if (fields != null) {
	        ...
	        for (var j = 0; j < fields.length; j++) {
	            ...
	            value_array[j] = field_item.get("phone_field");
	        }
	    }
	    var is_first = true;
	    var index = 0;
...
function parseSelectResponse(rows) {
    if (rows != null) {
        ...
        for (var kk = 0; kk < field_items.length; kk++) {
            ...
            var device_field = field_item.get("phone_field");
