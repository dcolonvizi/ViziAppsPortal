...
function command_condition_phone_field1_SelectedIndexChanged(sender, eventArgs) {
    var index = GetCommandIndexFromEventTarget(sender._uniqueId);
    var DBTreeInfo = document.getElementById("DBTreeInfo");
    DBTreeInfo.value = "command_condition_phone_field1;" + index + ";" + eventArgs._item._text;
    DoDatabaseChange();
}

function command_condition_phone_field1_Changed(sender, eventArgs) {
    var index = GetCommandIndexFromEventTarget(sender.name);
    var DBTreeInfo = document.getElementById("DBTreeInfo");
    DBTreeInfo.value = "command_condition_phone_field1;" + index + ";" + sender.value;
    DoDatabaseChange();
}
...
function command_condition_phone_field2_SelectedIndexChanged(sender, eventArgs) {
    var index = GetCommandIndexFromEventTarget(sender._uniqueId);
    var DBTreeInfo = document.getElementById("DBTreeInfo");
    DBTreeInfo.value = "command_condition_phone_field2;" + index + ";" + sender._text;
    DoDatabaseChange();
}

function command_condition_phone_field2_Changed(sender, eventArgs) {
    var index = GetCommandIndexFromEventTarget(sender.name);
    var DBTreeInfo = document.getElementById("DBTreeInfo");
    DBTreeInfo.value = "command_condition_phone_field2;" + index + ";" + sender.value;
    DoDatabaseChange();
}
...
function phone_field_SelectedIndexChanged(sender, eventArgs) {
    var index = GetFieldIndexFromEventTarget(sender._uniqueId);
    var DBTreeInfo = document.getElementById("DBTreeInfo");
    DBTreeInfo.value = "phone_field;" + index[0] + ";" + index[1] + ";" + sender._text;
    DoDatabaseChange();
}
...
function phone_field_Changed(sender, eventArgs) {
    ...
    var DBTreeInfo = document.getElementById("DBTreeInfo");
    DBTreeInfo.value = "phone_field;" + index[0] + ";" + index[1] + ";" + sender.value;
    DoDatabaseChange();
}
...
function command_condition_phone_field1_key_down(e)
{	
    var code = e.keyCode;
    if (code == '13') {
        command_condition_phone_field1_Changed(e.currentTarget, null);
        e.preventDefault();
        e.stopPropagation();
    }
};

function command_condition_phone_field2_key_down(e)
{	
    var code = e.keyCode;
    if (code == '13') {
        command_condition_phone_field2_Changed(e.currentTarget, null);
        e.preventDefault();
        e.stopPropagation();
    }
};
