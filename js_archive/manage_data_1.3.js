...
function onNodeDropping(sender, args) {
    ...
    if (target.tagName.toLowerCase() == "input" && target.className != "rcbInput") {
        ...
        if (target.id.indexOf('command_condition_phone_field1') >= 0) {
            command_condition_phone_field1_Changed(target);
        }
        else if (target.id.indexOf('command_condition_phone_field2') >= 0) {
            command_condition_phone_field2_Changed(target);
        }
        else if (target.id.indexOf('condition_2nd_field') >= 0) {
            condition_2nd_field_Changed(target);
        }
        else if (target.id.indexOf('phone_field') >= 0) {
