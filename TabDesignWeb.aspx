<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TabDesignWeb.aspx.cs" Inherits="TabDesignWeb" %>
...
<head id="Head1" runat="server">
    <title>ViziApps: Build Web Mobile Apps Online</title>
       ...
       <style type="text/css">
        ...
        <script language="javascript" type="text/javascript" src="EditorTools/js/editor_custom_tools_2.40.min.js"></script>
            ...
            <telerik:AjaxSetting AjaxControlID="SaveUrlAccountIdentifier">
                <UpdatedControls>
                     ...
                     <telerik:AjaxUpdatedControl ControlID="Message"/>  
                      ...
                      <telerik:AjaxUpdatedControl ControlID="QRCodeLabel" /> 
                       <telerik:AjaxUpdatedControl ControlID="CurrentAppContainer" /> 
                       <telerik:AjaxUpdatedControl ControlID="TestAppURL" />   
                ...
                <tr>              
                    <td style="height: 10px;" valign="top">                                
                                ...
                                <telerik:RadMultiPage runat="server" ID="DeviceMultiPage" SelectedIndex="0"   >
                                 <telerik:RadPageView runat="server" ID="iPhoneView"><div style="width:382px;height:746px;vertical-align:top; background-image:url(images/editor_images/iphone4_skin.gif);background-repeat:no-repeat"></div></telerik:RadPageView>
                                    <telerik:RadPageView runat="server" ID="AndroidView"><div style="width:374px;height:696px;vertical-align:top; background-image:url(images/editor_images/galaxy_android_skin.gif);background-repeat:no-repeat"></div></telerik:RadPageView>
                                     <telerik:RadPageView runat="server" ID="iPadPortraitView"><div style="border:0px;width:808px;height:1109px;vertical-align:top; background-image:url(images/editor_images/ipad_portrait_skin.gif);background-repeat:no-repeat"></div></telerik:RadPageView>
                                    ...
                                    <tr style="height:20px">
                                        <td style="height:20px">
                                                <asp:Label ID="StartMessage0" runat="server" Font-Bold="True" Font-Names="Arial" 
                                                    Font-Size="12pt" ForeColor="#000099" Height="20px" Width="132px">Web App Design </asp:Label>
                                        </td>
                            ...
                            <table style=" vertical-align: top;">
                                ...
                                </tr><tr><td class="style16" 
                                    valign="top">
                            </td><td align="left" class="style17" valign="top" >
                             <asp:Button ID="ValidateFieldNames" runat="server" 
                                             onclick="ValidateFieldNames_Click" Text="Validate Field References"  
                                        /> 
                    ...
                    <ToggleStates>
                        ...
                        <telerik:RadButtonToggleState  ImageUrl="~/images/show_app_design.png" HoveredImageUrl="~/images/show_app_design_hover.png"  />
                                ...
                                <td align="left" valign="top" class="style18" colspan="2">
                                   ...
                                   <table style="width: 286px; height: 20px"><tr><td><asp:Label ID="QRCodeLabel" 
                                           runat="server" Font-Bold="True" Font-Names="Arial" 
                                                Font-Size="10pt" ForeColor="#000099" 
                                                        Width="350px" style="display:none"></asp:Label></td><td> <img alt="" id="QRCode" width="150" height="150" runat="server" src="" style="display:none"/></td></tr></table></td></tr>
                                                      <tr>
                                <td align="left" valign="top" class="style19" colspan="2">
                                
                                   <asp:Label ID="TestAppURL" runat="server" Font-Bold="True" Font-Names="Arial" 
                                                Font-Size="10pt" ForeColor="#000099" 
                                                        Width="436px" ></asp:Label></td></tr>  </table> 
                                         </td>
                                         </tr>
                                         </table>                               
