...
<td><telerik:RadComboBox ID="command_condition_phone_field1" runat="server" CssClass="body"
        OnClientSelectedIndexChanged="command_condition_phone_field1_SelectedIndexChanged"  />
    </td>
    ...
    <td width="170">
     <telerik:RadComboBox ID="command_condition_phone_field2" runat="server"  CssClass="body"
        OnClientSelectedIndexChanged="command_condition_phone_field2_SelectedIndexChanged" 
        OnClientTextChange="command_condition_phone_field2_SelectedIndexChanged" 
