...
public partial class Controls_DatabaseToDeviceField : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (string name in fields)
        {
            device_field.Items.Add(new Telerik.Web.UI.RadComboBoxItem(name, name));
        }
        device_field.SelectedIndex = 0;
    }
}