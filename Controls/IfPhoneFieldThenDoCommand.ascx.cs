...
public partial class Controls_IfPhoneFieldThenDoCommand : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        command_condition_phone_field1.Items.Clear();
        command_condition_phone_field2.Items.Clear();
        ...
        {
            command_condition_phone_field1.Items.Add(new Telerik.Web.UI.RadComboBoxItem(name, name));
            command_condition_phone_field2.Items.Add(new Telerik.Web.UI.RadComboBoxItem(name, name));
        }

        command_condition_phone_field2.EmptyMessage = "Choose Field or Enter Text";
     }
}