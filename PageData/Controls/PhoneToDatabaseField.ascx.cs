...
public partial class Controls_PhoneToDatabaseField : System.Web.UI.UserControl
{
   public Controls_PhoneToDatabaseField()
   {
   }
   public Controls_PhoneToDatabaseField(string selected_database_field)
   {
