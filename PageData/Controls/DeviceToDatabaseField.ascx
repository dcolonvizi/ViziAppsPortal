<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DeviceToDatabaseField.ascx.cs" Inherits="Controls_DeviceToDatabaseField" %>
...
<td class="style1">
<input id="device_field" type="text" style="width: 135px;" 
        runat="server" onkeydown="phone_field_key_down(event);"   /></td>
<td style=" font-family:Verdana; font-size:11px; color:#333333">to worksheet field</td>
<td>
...
<td width="150">
    ...
    <telerik:RadComboBox ID="database_field" runat="server" CssClass="body"
         OnClientSelectedIndexChanged="database_field_SelectedIndexChanged"  /></td>
<td>
