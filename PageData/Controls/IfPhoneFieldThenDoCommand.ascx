...
<td>
<input id="command_condition_phone_field1" type="text" style="width: 135px;" onkeydown="command_condition_phone_field1_key_down(event);"
        runat="server"  
           />       
    </td>
    ...
    <td class="style2">
    <input id="command_condition_phone_field2" type="text" style="width: 135px;" 
        runat="server"  onkeydown="command_condition_phone_field2_key_down(event);" />          
   </td>
